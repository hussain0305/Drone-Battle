...
public class GyroController : MonoBehaviour 
{
	...
	public readonly Quaternion baseIdentity =  Quaternion.Euler(90, 0, 0);
    public readonly Quaternion landscapeRight =  Quaternion.Euler(0, 0, 90);
    public readonly Quaternion landscapeLeft =  Quaternion.Euler(0, 0, -90);
    public readonly Quaternion upsideDown =  Quaternion.Euler(0, 0, 180);
	
	public Quaternion cameraBase =  Quaternion.identity;
	public Quaternion calibration =  Quaternion.identity;
	public Quaternion baseOrientation =  Quaternion.Euler(90, 0, 0);
	public Quaternion baseOrientationRotationFix =  Quaternion.identity;

	public Quaternion referanceRotation = Quaternion.identity;
